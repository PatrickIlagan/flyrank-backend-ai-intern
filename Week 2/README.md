...
- [x] **AI Fluency Track (FL_04: Frame Your Work)**: Framed project case studies (PrismLearning.AI & Task API) using the 3-beat structure, defined personal voice card, crafted bio/CTA, and produced before/after comparisons. See `fluency/`.
...
- Framed case studies (.docx and .md deliverables) live in `fluency/`.
