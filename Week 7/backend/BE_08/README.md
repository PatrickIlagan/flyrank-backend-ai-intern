...
- [x] **Stage 2: Boring SQL is 80% of Reporting**: Write SQL aggregation queries (totals, averages, top 5, daily breakdown) in `get_report_data()`.
- [x] **Stage 3: Render: From Numbers to a PDF**: Build HTML report template with print CSS (`page-break-inside: avoid`), render to multi-page PDF via Playwright.
